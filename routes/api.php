...
Route::group(['prefix' => 'profile'], function () {
    ...
    // История транзакциЙ
    Route::get('transaction_history', [ProfileController::class, 'getTransactionHistory'])->name('api.profile.transaction_history');
    // запрос на получения баланса
    Route::get('balance/{cryptocurrency}', [ProfileController::class, 'getBalance'])->name('api.profile.balance');
    // история кейсов
    Route::post('box-payment-history', [ProfileController::class, 'getBoxPaymentHistory'])->name('api.profile.box_payment_history');
