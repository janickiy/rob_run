...
class DataTableController extends Controller
{
    ...
    {
        $row = User::selectRaw('users.id,users.name,users.email,users.is_ban,users.created_at,count(box_payment_history.user_id) as number_tickets_purchased, sum(box_payment_history.payment_usd) as amount_money_spent, sum(box_payment_history.win) as number_open_cases')
    ...
    {
        $row = BoxPaymentHistory::selectRaw('users.name,users.email,COUNT(users.id) as number_tickets')->where('box_id', $box_id)
