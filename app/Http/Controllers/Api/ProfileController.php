...
class ProfileController extends Controller
{
    ...
    public function getTransactionHistory(): JsonResponse
    {
        ...
        foreach (TransactionHistory::where('user_id', $this->user->id)->get() as $row) {
            $items[] = [
                'id' => $row->id,
    ...
    public function getBoxPaymentHistory(BoxPaymentHistoryRequest $request): JsonResponse
    {
        ...
        $boxPaymentHistory = BoxPaymentHistory::where('user_id', $this->user->id);
        ...
        return response()->json(['item' => $items, 'count' => $count]);
    ...
    public function wallets(): JsonResponse
    {
        ...
        foreach (Wallet::where('user_id', $this->user->id)->get() as $row) {
            $items[] = [
                'id' => $row->id,
                'address' => $row->address,
                'balance' => $row->balance,
